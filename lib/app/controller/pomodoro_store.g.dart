...
mixin _$PomodoroStore on _PomodoroStoreBase, Store {
  late final _$iniciadoAtom =
      Atom(name: '_PomodoroStoreBase.iniciado', context: context);
  ...
  late final _$minutosAtom =
      Atom(name: '_PomodoroStoreBase.minutos', context: context);
  ...
  late final _$segundosAtom =
      Atom(name: '_PomodoroStoreBase.segundos', context: context);
  ...
  late final _$tempoTrabalhoAtom =
      Atom(name: '_PomodoroStoreBase.tempoTrabalho', context: context);
  ...
  late final _$tempoDescansoAtom =
      Atom(name: '_PomodoroStoreBase.tempoDescanso', context: context);
  ...
  late final _$tipoIntervaloAtom =
      Atom(name: '_PomodoroStoreBase.tipoIntervalo', context: context);
